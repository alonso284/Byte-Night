...
unsigned long Auth = 598563756; //uid con el que se acepta la tarjeta

//datos de mi internet
const char* ssid = "Totalplay-74A4"; 
const char* password = "74A468C8k2a3T6Je";
int acce = 0; //indicador de acceso

HTTPClient httpClient;
WiFiClient wClient;

String URL = "http://192.168.100.52:3100/api/logUid/";
